...
function initAdmin() {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      ...
      return "\n            <p> ".concat(menuItem.totalPrice, " pcs </p>\n            ");
    }).join('');
  }
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var dish = JSON.parse(btn.dataset.dish); //console.log('ishaannnnnnnnnnnnnnnnnnnnnnnnnnnnn');
...
__webpack_require__(/*! /home/ishaan/Music/tobeuploaded on github/resturant delivery app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/ishaan/Music/tobeuploaded on github/resturant delivery app/resources/scss/app.scss */"./resources/scss/app.scss");
